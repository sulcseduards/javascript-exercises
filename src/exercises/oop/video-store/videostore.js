class Video {
    ...
    get print() {
        let movieInfo = `${this.name}, ${this.getAverageUserRating().toFixed(1)}, ${this.likedMovies().toFixed(1)}% users liked it. `
        return this.isRented ? `${movieInfo}Movie is not available.` : `${movieInfo}Movie is available`;
    }
    ...
    getAverageUserRating() {
        return this.allUserRatings.reduce((a, b) => a + b) / this.allUserRatings.length
    }
